UNIX BUILD NOTES
====================
Some notes on how to build Bitcloud Core in Unix.

Note
---------------------
Always use absolute paths to configure and compile Bitcloud Core and the dependencies,
...
memory available when compiling Bitcloud Core. On systems with less, gcc can be
...
To build Bitcloud Core without wallet, see [*Disable-wallet mode*](/doc/build-unix.md#disable-wallet-mode)
...
Security
--------
To help make your Bitcloud Core installation more secure by making certain attacks impossible to
...
* _Non-executable Stack_: If the stack is executable then trivial stack-based buffer overflow exploits are possible if
    vulnerable buffers are found. By default, Bitcloud Core should be built with a non-executable stack
...
When the intention is to run only a P2P node without a wallet, Bitcloud Core may be compiled in
