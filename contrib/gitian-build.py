...
def setup_repos():
    ...
    if not os.path.isdir('pivx-detached-sigs'):
        subprocess.check_call(['git', 'clone', 'https://github.com/LIMXTEC/Bitcloud-detached-sigs.git'])
    if not os.path.isdir('gitian-builder'):
        subprocess.check_call(['git', 'clone', 'https://github.com/devrandom/gitian-builder.git'])
    if not os.path.isdir('pivx'):
        subprocess.check_call(['git', 'clone', 'https://github.com/LIMXTEC/Bitcloud.git'])
...
def main():
    ...
    parser.add_argument('-u', '--url', dest='url', default='https://github.com/LIMXTEC/Bitcloud', help='Specify the URL of the repository. Default is %(default)s')
