...
// The zPIV/zGROW block index is the first appearance of the accumulator checksum that was used in the spend
...
{
    //The unique identifier for a zPIV/zGROW is a hash of the serial
...
{
    //Create an output returning the zPIV/zGROW that was staked
    CTxOut outReward;
...
{
    //The unique identifier for a PIV/GROW stake is the outpoint
