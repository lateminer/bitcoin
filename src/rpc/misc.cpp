...
UniValue getinfo(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 0)
        throw std::runtime_error(
            ...
            "     \"5\" : n,            (numeric) supply of 5 zBTDX denomination\n"
            "     \"10\" : n,           (numeric) supply of 10 zBTDX denomination\n"
            "     \"50\" : n,           (numeric) supply of 50 zBTDX denomination\n"
            "     \"100\" : n,          (numeric) supply of 100 zBTDX denomination\n"
            "     \"500\" : n,          (numeric) supply of 500 zBTDX denomination\n"
            "     \"1000\" : n,         (numeric) supply of 1000 zBTDX denomination\n"
...
UniValue validateaddress(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw std::runtime_error(
            "validateaddress \"bitcloudaddress\"\n"
            "\nReturn information about the given bitcloud address.\n"

            "\nArguments:\n"
            "1. \"bitcloudaddress\"     (string, required) The bitcloud address to validate\n"

            "\nResult:\n"
            "{\n"
            "  \"isvalid\" : true|false,         (boolean) If the address is valid or not. If not, this is the only property returned.\n"
            "  \"address\" : \"bitcloudaddress\",    (string) The bitcloud address validated\n"
            "  \"scriptPubKey\" : \"hex\",       (string) The hex encoded scriptPubKey generated by the address\n"
            "  \"ismine\" : true|false,          (boolean) If the address is yours or not\n"
            "  \"isstaking\" : true|false,       (boolean) If the address is a staking address for Bitcloud cold staking\n"
...
#ifdef ENABLE_WALLET
        // Case 1: Bitcloud address and we have full public key:
...
UniValue createmultisig(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() < 2 || params.size() > 2)
        throw std::runtime_error(
            ...
            "2. \"keys\"       (string, required) A json array of keys which are bitcloud addresses or hex-encoded public keys\n"
            "     [\n"
            "       \"key\"    (string) bitcloud address or hex-encoded public key\n"
            "       ,...\n"
            "     ]\n"
...
UniValue verifymessage(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 3)
        throw std::runtime_error(
            "verifymessage \"bitcloudaddress\" \"signature\" \"message\"\n"
            "\nVerify a signed message\n"

            "\nArguments:\n"
            "1. \"bitcloudaddress\"  (string, required) The bitcloud address to use for the signature.\n"
