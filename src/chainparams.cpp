...
public:
    CMainParams() {
        ...
        consensus.vDeployments[Consensus::DEPLOYMENT_CSV].nStartTime = 4102444800; // Jan 1st, 2100
        consensus.vDeployments[Consensus::DEPLOYMENT_CSV].nTimeout = 4133980800; // Jan 1st, 2101
