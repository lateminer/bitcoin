...
public:
    CMainParams()
    {
         ...
         */
        pchMessageStart[0] = 0xe4; // BTDX
        pchMessageStart[1] = 0xe8; // BTDX
        pchMessageStart[2] = 0xbd; // BTDX
        pchMessageStart[3] = 0xfd; // BTDX
        vAlertPubKey = ParseHex("0000098d3ba6ba6e7423fa5cbd6a89e0a9a5348f88d332b44a5cb1a8b7ed2c1eaa335fc8dc4f012cb8241cc0bdafd6ca70c5f5448916e4e6f511bcd746ed57dc50");
        nDefaultPort = 8329;       // BTDX
        bnProofOfWorkLimit = ~uint256(0) >> 20; // PIVX/BTDX starting difficulty is 1 / 2^12
        bnProofOfStakeLimit = ~uint256(0) >> 24;
        bnProofOfStakeLimit_V2 = ~uint256(0) >> 20; // 60/4 = 15 ==> use 2**4 higher limit
        nSubsidyHalvingInterval = 210000;    // BTDX
        nMaxReorganizationDepth = 100;       // BTDX
        nEnforceBlockUpgradeMajority = 750;  // BTDX
        nRejectBlockOutdatedMajority = 950;  // BTDX
        nToCheckBlockUpgradeMajority = 1000; // BTDX
        nMinerThreads = 0;                   // BTDX
        nTargetSpacing = 1 * 300;                       // BTDX
        nTargetTimespan = 1 * 300 * 40;                 // BTDX
        nTimeSlotLength = 15;                           // 15 seconds
        nTargetTimespan_V2 = 2 * nTimeSlotLength * 60;  // 30 minutes
        nMaturity = 144;                                // BTDX
        nStakeMinAge = 60 * 60;                         // BTDX
        nStakeMinDepth = 600;
        nFutureTimeDriftPoW = 7200;                     // BTDX
        nFutureTimeDriftPoS = 180;                      // BTDX
        nMasternodeCountDrift = 20;                     // BTDX
        nMaxMoneyOut = 21000000 * COIN;                 // BTDX
        nMinColdStakingAmount = 1 * COIN;

        /** Height or Time Based Activations **/
        nLastPOWBlock = 300;                            // BTDX
        ...
        nModifierUpdateBlock = 1;                       // BTDX

        // BTDX
        nZerocoinStartHeight = std::numeric_limits<int>::max();
        nZerocoinStartTime = std::numeric_limits<int>::max(); // October 17, 2017 4:30:00 AM
        ...
        nRejectOldSporkKey = std::numeric_limits<int>::max(); //!> Fully reject old spork key after Thursday, September 26, 2019 11:00:00 PM GMT
        ...
        // Blocks v7
        nBlockLastAccumulatorCheckpoint = std::numeric_limits<int>::max();
        ...
        nBudgetCycleBlocks = 8640; //!< Amount of blocks in a months period of time (using 1 minutes per) = (12*24*30)
        strSporkPubKey = "04DA111581AB2E25EB1F0AD98E0CC168EDE663C6282B0FF7C20B33D205E9F0F8A1B4905CC81B2003D2AFA360BE9A317CD130B4530EABDB182FDC50202E28F28659";
        strSporkPubKeyOld = "04DA111581AB2E25EB1F0AD98E0CC168EDE663C6282B0FF7C20B33D205E9F0F8A1B4905CC81B2003D2AFA360BE9A317CD130B4530EABDB182FDC50202E28F28659";
        strObfuscationPoolDummyAddress = "BHC9RXJiBkfsmC6edT61hRNq2NZMPe3unJ";
...
public:
    CTestNetParams()
    {
        ...
        nDefaultPort = 8330;               // BTDX
        nEnforceBlockUpgradeMajority = 51; // BTDX: 75%
        nRejectBlockOutdatedMajority = 75; // BTDX: 95%
        nToCheckBlockUpgradeMajority = 100; // BTDX: 4 days
        nMinerThreads = 0;
        nTargetTimespan = 1 * 135 * 40;     // BTDX
        nTargetSpacing = 1 * 135;           // BTDX
        nLastPOWBlock = 200;
        ...
        strSporkPubKey = "04982ABC443EB2F4A9EB73B9ED73456CAAB10071A2DED9761BCFDE1997B55BA810C3A95415D203296ADAE60F8DF348941C0DA1FCD70137C0069207CEE213C33E23";
        strSporkPubKeyOld = "04982ABC443EB2F4A9EB73B9ED73456CAAB10071A2DED9761BCFDE1997B55BA810C3A95415D203296ADAE60F8DF348941C0DA1FCD70137C0069207CEE213C33E23";
        strObfuscationPoolDummyAddress = "y9GT3SSVAditTmC2ZkykzeDpg9zmCYMwEw";
...
public:
    CRegTestParams()
    {
        ...
        nMinerThreads = 1;
        nTargetTimespan = 24 * 60 * 60 * 40; // BTDX
        nTargetSpacing = 1 * 60;             // BTDX
        ...
        hashGenesisBlock = genesis.GetHash();
        assert(hashGenesisBlock == uint256("0x000002d56463941c20eae5cb474cc805b646515d18bc7dc222a0885b206eadb0")); // BTDX
