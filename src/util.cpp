...
std::string CopyrightHolders(const std::string& strPrefix)
{
    ...
    strCopyrightHolders += "\n" + strPrefix + strprintf(" %u-%u ", 2014, COPYRIGHT_YEAR) + "The Talkcoin developers";
    strCopyrightHolders += "\n" + strPrefix + strprintf(" %u-%u ", 2017, COPYRIGHT_YEAR) + "The Zcoin developers";
    strCopyrightHolders += "\n" + strPrefix + strprintf(" %u-%u ", 2017, COPYRIGHT_YEAR) + "The PIVX developers";
