...
std::vector<CSporkDef> sporkDefs = {
    ...
    MAKE_SPORK_DEF(SPORK_19_NEW_PROTOCOL_ENFORCEMENT_3,     4070908800ULL), // OFF // BTDX
};
...
// PIVX & Bitcloud: on startup load spork values from previous session if they exist in the sporkDB
...
void CSporkManager::ProcessSpork(CNode* pfrom, std::string& strCommand, CDataStream& vRecv)
{
    ...
    if (strCommand == "spork") {
        ...
        // PIVX & Bitcloud: add to spork database.
