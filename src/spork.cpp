...
bool CSporkManager::IsSporkActive(int nSporkID)
{
    ...
    if(mapSporksActive.count(nSporkID)){
        ...
        switch (nSporkID) {
            ...
            case SPORK_FXTC_03_BLOCK_REWARD_PERCENT_START:   r = SPORK_FXTC_03_BLOCK_REWARD_PERCENT_START_DEFAULT; break;
			case SPORK_FXTC_03_FUNDRAISING_START:   r = SPORK_FXTC_03_FUNDRAISING_START_DEFAULT; break;
            // FXTC END
            default:
...
int64_t CSporkManager::GetSporkValue(int nSporkID)
{
    ...
    switch (nSporkID) {
        ...
        case SPORK_FXTC_03_BLOCK_REWARD_PERCENT_START:   return SPORK_FXTC_03_BLOCK_REWARD_PERCENT_START_DEFAULT;
		case SPORK_FXTC_03_FUNDRAISING_START:   return SPORK_FXTC_03_FUNDRAISING_START_DEFAULT;
...
int CSporkManager::GetSporkIDByName(std::string strName)
{
    ...
    if (strName == "SPORK_FXTC_03_BLOCK_REWARD_PERCENT_START")   return SPORK_FXTC_03_BLOCK_REWARD_PERCENT_START;
	if (strName == "SPORK_FXTC_03_FUNDRAISING_START")   return SPORK_FXTC_03_FUNDRAISING_START;
...
std::string CSporkManager::GetSporkNameByID(int nSporkID)
{
    switch (nSporkID) {
        ...
        case SPORK_FXTC_03_BLOCK_REWARD_PERCENT_START:   return "SPORK_FXTC_03_BLOCK_REWARD_PERCENT_START";
		case SPORK_FXTC_03_FUNDRAISING_START:   return "SPORK_FXTC_03_FUNDRAISING_START";
