...
int64_t GetSporkValue(int nSporkID)
{
    ...
    if (mapSporksActive.count(nSporkID)) {
        ...
        if (nSporkID == SPORK_14_NEW_PROTOCOL_ENFORCEMENT) r = SPORK_14_NEW_PROTOCOL_ENFORCEMENT_DEFAULT; // MIN_PEER_PROTO_VERSION_AFTER_ENFORCEMENT_GROWNNEWNET_40003
        if (nSporkID == SPORK_15_NEW_PROTOCOL_ENFORCEMENT_2) r = SPORK_15_NEW_PROTOCOL_ENFORCEMENT_2_DEFAULT; // MIN_PEER_PROTO_VERSION_AFTER_ENFORCEMENT_GROWNNEWNET_40004
