 ...
 * Bitcloud system. There are three: the main network on which people trade goods
...
public:
    ...
    int64_t TargetTimespan(const bool fV2 = false) const { return fV2 ? nTargetTimespan_V2 : nTargetTimespan; }
