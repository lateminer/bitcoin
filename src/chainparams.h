 ...
 * PIVX/GROW system. There are three: the main network on which people trade goods
...
public:
    ...
    int CoinbaseMaturity() const { return nMaturity; }
    ...
    int Initial_Fork1_Height() const { return nInitialFork1Height; }
