...
void AskPassphraseDialog::accept()
{
    ...
    case Mode::Encrypt: {
        ...
        bool ret = openStandardDialog(
                ...
                " <b>" + tr("LOSE ALL OF YOUR BTDX") + "</b>!<br><br>" + tr("Are you sure you wish to encrypt your wallet?"),
...
void AskPassphraseDialog::warningMessage()
{
    ...
    openStandardDialog(
            tr("Wallet encrypted"),
            "<qt>" +
            tr("Bitcloud will close now to finish the encryption process. "
               "Remember that encrypting your wallet cannot fully protect "
               "your BTDXs from being stolen by malware infecting your computer.") +
            "<br><br><b>" +
