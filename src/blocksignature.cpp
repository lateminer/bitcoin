...
bool CheckBlockSignature(const CBlock& block)
{
    ...
    /** Each block is signed by the private key of the input that is staked. This can be either zPIV/zGROW or normal UTXO
     *  zPIV/zGROW: Each zPIV/zGROW has a keypair associated with it. The serial number is a hash of the public key.
